...
- **Dashboard** — characters, alerts, stamps, bubbles, bribes, statues, cards, post office, death note, rift, sailing, slab, islands, farming, caverns
- **Characters** — skill matrix across the roster
- **AutoReview** — Pinchy-style “do this first” plus General / W1–W7 groups (stamps, vault, owl, alchemy, post office, islands, construction, death note, printer, atoms, meals, breeding, lab, rift, sailing, divinity, gaming, slab, caverns, farming, sneaking, summoning, coral reef)
