...
- **Dashboard** — characters, alerts, stamps, bubbles, bribes, statues, cards, post office, death note, rift, sailing, slab
- **Characters** — skill matrix across the roster
- **AutoReview** — Pinchy-style “do this first” plus General / W1–W7 groups (stamps, vault, star signs, alchemy, post office, construction, death note, printer, atoms, meals, breeding, lab, rift, sailing, divinity, gaming, slab, later-world skills)
